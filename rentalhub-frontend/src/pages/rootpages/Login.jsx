      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0f172a] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-blue-500 focus:ring-blue-500 border-gray-600 rounded bg-[#0f172a]"
              />
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="w-full inline-flex justify-center py-3 px-4 border border-gray-600 rounded-lg shadow-sm bg-[#0f172a] text-sm font-medium text-gray-300 hover:bg-gray-700/50 transition-all duration-200"
            >
